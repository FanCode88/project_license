...
// Folosim MySQLi orientat pe obiecte sau procedural (aici folosim procedural pentru compatibilitate directă)
$conn = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_DATABASE);
if (!$conn) {
    die('Failed to connect to server: ' . mysqli_connect_error());
}

// Setăm charset-ul pentru a evita problemele cu caracterele speciale
    ...
    <div id="page">
                        ...
                        <div style="border:#bd6f2f solid 1px; padding:15px; border-radius:5px;">
                            ...
                            <form name="registerForm" method="post" action="register-exec.php"
                                ...
                                <table border="0" align="center" cellpadding="3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="question" style="width:156px;">
                                                ...
                                                <?php
                                                // Resetăm pointerul rezultatului în MySQLi
                                    ...
                                    <tr>
                                        <td colspan="2" style="padding-top:10px;"><input type="submit" name="Submit"
                                                value="Register" /></td>
                                    </tr>
                                </table>
                            </form>
        ...
        <div id="footer">
            <div class="bottom_menu">
                <a href="home.htm">Home Page</a> | <a href="aboutus.htm">About Us</a> | <a href="foodzone.php">Food
                    Zone</a> |
