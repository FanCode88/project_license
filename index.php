        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Bun venit în sistemul de comenzi online al restaurantului
          ...
          <div class="carousel-item" style="background: url(assets/img/slide/slide-2.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Bun venit în sistemul de comenzi online al restaurantului
                  Deluxe! Comandă-ți astăzi mâncarea de la Deluxe, iar noi ți-o vom livra direct la ușă.</p>
                <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Menu</a>
                  <a href="member-index.php" class="btn-book animate__animated animate__fadeInUp scrollto">Book a
                    Table</a>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item" style="background: url(assets/img/slide/slide-3.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Deluxe restaurant</h2>
                <p class="animate__animated animate__fadeInUp">Comandă-ți astăzi mâncarea de la Deluxe, iar noi ți-o vom
                  livra direct la ușă. Nu rata ofertele noastre speciale săptămânale din meniul „Oferte Speciale”!</p>
                <div>
              ...
              <ul class="nav nav-pills custom-tabs mb-4 justify-content-center" id="authTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="register-tab" data-bs-toggle="tab" data-bs-target="#register-panel"
                    type="button" role="tab" aria-controls="register-panel" aria-selected="false">Cont Nou</button>
                </li>
              </ul>
                ...
                <div class="tab-pane fade" id="register-panel" role="tabpanel" aria-labelledby="register-tab">
                  <form id="registerForm" name="registerForm" method="post" action="register-exec.php"
                    ...
                    <div class="row g-2 mb-3">
                      <div class="col-md-6">
                        ...
                        <input name="fname" type="text" id="fname"
                          class="form-control form-control-lg border-secondary shadow-sm" placeholder="Ex: Ion"
                          required />
                      </div>
                      <div class="col-md-6">
                        <label for="lname" class="fw-bold">Nume <span class="text-danger">*</span></label>
                        <input name="lname" type="text" id="lname"
                          class="form-control form-control-lg border-secondary shadow-sm" placeholder="Ex: Popescu"
                          required />
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input name="login" type="text" id="reg_email"
                        class="form-control form-control-lg border-secondary shadow-sm" placeholder="Ex: nume@yahoo.com"
                        required />
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <input name="cpassword" type="password" id="cpassword"
                          class="form-control form-control-lg border-secondary shadow-sm" placeholder="Repetă parola"
                          required />
                      </div>
                    </div>

                    <div class="mb-3">
                      <label for="question" class="fw-bold">Întrebare de Securitate <span
                          class="text-danger">*</span></label>
                      <select name="question" id="question"
                        class="form-select form-select-lg border-secondary shadow-sm">
    ...
    <section id="why-us" class="why-us">
      <div class="container">
        <div class="section-title">
          ...
          <p>Pasiunea noastră pentru gastronomie ne-a condus la crearea Olive, un restaurant cu specific mediteranean și
            bucătărie responsabilă.</p>
        </div>
        <div class="row g-4">
          <div class="col-lg-6">
            <div class="box">
    ...
    <section id="menu" class="menu">
      <div class="container">
        ...
        <form name="categoryForm" id="categoryForm" method="post" action="foodzone.php"
          onsubmit="return categoriesValidate(this)" class="mb-4">
            ...
            <tbody>
              ...
              <?php else: ?>
                <?php foreach ($food_items as $item): ?>
                  <tr>
                    <td><a href="images/<?php echo $item['food_photo']; ?>" target="_blank"><img
                          src="images/<?php echo $item['food_photo']; ?>" width="80" height="70" class="rounded"></a></td>
                    <td><b><?php echo htmlspecialchars($item['food_name']); ?></b></td>
                    <td><a href="images/<?php echo $item['foodQR']; ?>" target="_blank"><img
                          src="images/<?php echo $item['foodQR']; ?>" width="80" height="70"></a></td>
                    <td><?php echo htmlspecialchars($item['category_name']); ?></td>
                    <td><span
                        class="text-success font-weight-bold"><?php echo (isset($symbol['currency_symbol']) ? $symbol['currency_symbol'] : '$') . $item['food_price']; ?></span>
                    </td>
                    <td><a href="cart-exec.php?id=<?php echo $item['food_id']; ?>"
                        class="btn btn-sm btn-warning rounded-pill px-3">Add To Cart</a></td>
                  </tr>
                <?php endforeach; ?>
              <?php endif; ?>
            </tbody>
    ...
    <section id="specials" class="specials">
      <div class="container">
        <div class="section-title text-center">
          ...
          <p>Descoperă ofertele noastre de mai jos. Atenție, acestea sunt disponibile pentru o perioadă limitată! Nu
            lăsa ocazia să treacă.</p>
          <small class="text-muted"><strong>Notă:</strong> Pentru a plasa o comandă, te rugăm să accesezi pagina
            <strong>Food Zone</strong> și să alegi categoria <strong>Specials</strong> din listă.</small>
        </div>
          ...
          <table class="table text-center align-middle">
            ...
            <tbody>
              <?php foreach ($specials as $row): ?>
                <tr>
                  <td><a href="images/<?php echo $row['special_photo']; ?>" target="_blank"><img
                  ...
                  <td><span
                      class="text-success font-weight-bold"><?php echo (isset($symbol['currency_symbol']) ? $symbol['currency_symbol'] : '$') . $row['special_price']; ?></span>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
    ...
    <section id="chefs" class="chefs">
      <div class="container">
        <div class="section-title">
          ...
          <p>Pasiunea și talentul echipei noastre culinare transformă fiecare ingredient într-o experiență memorabilă.
          </p>
        </div>
      ...
      <div class="container">
        ...
        <div class="form-container-box max-w-600 mx-auto gap-2 text-center">
          ...
          <form name="tableForm" id="tableForm" method="post"
            action="reserve-exec.php?id=<?php echo htmlspecialchars($memberId); ?>"
            onsubmit="return tableValidate(this)">
    ...
    <section id="gallery" class="gallery">
      <div class="container-fluid">
        <div class="section-title text-center">
          ...
          <p>Te invităm să descoperi atmosfera caldă și designul rafinat care fac din DELUXE locul ideal pentru
            momentele tale speciale.</p>
        </div>
        <div class="row g-1">
          <?php for ($i = 1; $i <= 8; $i++): ?>
          ...
          <div class="container">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form bg-white p-5 shadow-lg">
              <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                  <input type="email" class="form-control form-control-lg border-secondary" name="email"
                    placeholder="Your Email" required>
                </div>
              </div>
              <div class="form-group mb-3">
                <input type="text" class="form-control form-control-lg border-secondary" name="subject"
                  placeholder="Subject" required>
              </div>
              <div class="form-group mb-3">
                <textarea class="form-control form-control-lg border-secondary" name="message" rows="5"
                  placeholder="Message" required></textarea>
              </div>
              <div class="text-center mt-4">
                <button type="submit" class="btn btn-warning btn-lg px-5 text-white fw-bold shadow">Send
                  Message</button>
              </div>
            </form>
          </div>
