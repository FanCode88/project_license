...
if (isset($_POST['Delete']) && isset($_POST['question'])) {
    ...
    $stmt = mysqli_prepare($link, "DELETE FROM questions WHERE question_id = ?");
    ...
    if ($result) {
        ...
        mysqli_stmt_close($stmt);
        mysqli_close($link);
        die("There was a problem while deleting the question ... \n" . $error);
    }
} else {
    mysqli_close($link);
