    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="specialdeals.php">Specials</a></li>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background: url(assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Welcome To Deluxe Restaurant Online Ordering System!

                  Order your food today from the Deluxe and it will be delivered at your door step. Jump in to our weekly special deals in the Special Deals menu. .</p>
                <div>
          ...
          <div class="carousel-item" style="background: url(assets/img/slide/slide-3.jpg);">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Deluxe restaurant</h2>
                <p class="animate__animated animate__fadeInUp">Order your food today from the Deluxe and it will be delivered at your door step. Jump in to our weekly special deals in the Special Deals menu.</p>
                <div>
                  <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our Food</a>
                  <a href="#book-a-table" class="btn-book animate__animated animate__fadeInUp scrollto">Book a Table</a>
                </div>
  ...
  <main id="main">
                    ...
                    <form id="loginForm" name="loginForm" method="post" action="login-exec.php" onsubmit="return loginValidate(this)">
                      <table width="290" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td width="188">
                            <font color="#FF0000">* </font><input name="login" type="text" class="textfield" id="login" />
                          </td>
                        </tr>
                        <tr>
                          <td><b>Password</b></td>
                          <td>
                            <font color="#FF0000">* </font><input name="password" type="password" class="textfield" id="password" />
                          </td>
                        </tr>
                        <tr>
                    ...
                    <form id="loginForm" name="loginForm" method="post" action="register-exec.php" onsubmit="return registerValidate(this)">
                      <table width="450" border="0" align="center" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                          <th>First Name </th>
                          <td>
                            <font color="#FF0000">* </font><input name="fname" type="text" class="textfield" id="fname" />
                          </td>
                        </tr>
                        <tr>
                          <th>Last Name </th>
                          <td>
                            <font color="#FF0000">* </font><input name="lname" type="text" class="textfield" id="lname" />
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <font color="#FF0000">* </font><input name="cpassword" type="password" class="textfield" id="cpassword" />
                          </td>
                        </tr>
                        <tr>
                          <th>Security Question </th>
                          <td>
                            <font color="#FF0000">* </font><select name="question" id="question">
                        ...
                        <tr>
                          ...
                          <td>
                            <font color="#FF0000">* </font><input name="answer" type="text" class="textfield" id="answer" />
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2"><input type="reset" value="Clear Fields" />
    ...
    <section id="why-us" class="why-us">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>
            Our passion for gastronomy led us to create Olive, a restaurant in the heart of Oltenia,
            with a Mediterranean specificity and responsible cuisine, a place where we share with those who cross our threshold the taste of authentic food and the love for selected wines.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="box">
              <span>01</span>
              <h4>The aspect of our restaurant</h4>
              <p>At DELUXE, we pride ourselves with one of most beautiful restaurants in our country and beyond. </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              <span>02</span>
              <h4>The Quality</h4>
              <p>We have prepared a generous selection of special dishes for you, to savor and enjoy in the delightful atmosphere of this modern, exclusive and absolutely out of the ordinary space with its unique view.</p>
            </div>
          </div>
    ...
    <section id="menu" class="menu">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Check our food <span> </span></h2>
        </div>
        ...
        <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
          <table width="660" height="auto" style="text-align:center;">
            <tr>
              <th>Food Photo</th>
              <th>Food Name</th>
            ...
            if (isset($_POST['Submit']) && $count < 1) {
              ...
              while ($row = mysql_fetch_assoc($result)) {
                ...
                echo "<td><a href='images/" . $row['foodQR'] . "' alt='click to view full image' target='_blank'><img src='images/" . $row['foodQR'] . "' width='80' height='70'></a></td>";
              ...
              <table align="center" width="300">
                ...
                <tr>
                  ...
                  <td><select name="table" id="table">
                      <option value="select">- select table number -
                        <?php
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="">Abhishek Bhandari</a>
      </div>
    </div>
  </footer><!-- End Footer -->
