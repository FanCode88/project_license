...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.php#login" class="book-a-table-btn scrollto">Login</a>
    ...
    <section class="inner-page">
      ...
      <div id="center">
        ...
        <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
          <p>&nbsp;</p>
          <p><a href="index.php#login">Click Here</a> to login to your account.</p>
        </div>
      </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Saceanu Sorin Ionut</a>
      </div>
    </div>
  </footer><!-- End Footer -->
